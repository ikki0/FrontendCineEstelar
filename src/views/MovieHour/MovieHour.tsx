...
function MovieHour(): React.JSX.Element {
    ...
    useEffect(() => {
        ...
        // *  selectedCineId
        // *  selectedPeliculaId  
        const idCine = window.localStorage.getItem("selectedCineId") || 'No hay cine id';
        const idPelicula = window.localStorage.getItem("selectedPeliculaId") || 'No hay pelicula id';
