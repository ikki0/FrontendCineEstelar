...
function NosotrosComponent(): React.JSX.Element {
  return (
    <>
      <header>
        <TitleContainer title='¿Por qué nosotros?'/>
      </header>
      <article className="article">
        ...
        <ol>
          <li>
            <b>1. Entretenimiento con Propósito: </b>Disfruta de las mejores
          ...
          <li>
            <b>2. Cine con Conciencia:</b> Dos veces al mes, te invitamos a unirte
          ...
          <li>
            <b>3. Experiencia Única:</b> En CineEstelar, no solo vas a ver una
          ...
          <li>
            <b>4. Compromiso con la Comunidad: </b>Nos preocupamos por nuestra
